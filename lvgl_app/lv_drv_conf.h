...
#if USE_EVDEV
#  define EVDEV_NAME   "/dev/input/event7"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
#  define EVDEV_SWAP_AXES         0               /*Swap the x and y axes of the touchscreen*/

#  define EVDEV_SCALE             0               /* Scale input, e.g. if touchscreen resolution does not match display resolution */
#  if EVDEV_SCALE
#    define EVDEV_SCALE_HOR_RES     (65535)          /* Horizontal resolution of touchscreen */
#    define EVDEV_SCALE_VER_RES     (65535)          /* Vertical resolution of touchscreen */
#  endif  /*EVDEV_SCALE*/
